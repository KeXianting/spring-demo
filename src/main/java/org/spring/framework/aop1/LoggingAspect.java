...
public class LoggingAspect {
	 ...
	 */
	@Pointcut("execution(public int org.spring.framework.aop1.ArithmeticCalculator.*(..))")
	 ...
	 */
	//在@before和@after之前执行
	@Around("execution(public int org.spring.framework.aop1.ArithmeticCalculator.*(..))")
	public Object aroundMethod(ProceedingJoinPoint pjd){
		...
		try {
			//前置通知
			System.out.println("The method around " + methodName + " begins with " + Arrays.asList(pjd.getArgs()));
			//执行目标方法
			result = pjd.proceed();
			//返回通知
