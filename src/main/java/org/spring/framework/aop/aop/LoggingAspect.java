package org.spring.framework.aop.aop;
...
public class LoggingAspect {
	...
	@Before("execution(public int org.spring.framework.aop.aop.ArithmeticCalculator.*(int, int))")
	...
	@After("execution(* org.spring.framework.aop.aop.*.*(..))")
